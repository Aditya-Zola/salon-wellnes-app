            ...
            <section class="access-card form-card">
                <div class="access-card-head">
                    <div>
                        ...
                        <p>Akun dapat langsung digunakan untuk masuk.</p>
                    </div>
                </div>
                <form method="POST" action="{{ route('access.users.store') }}" class="access-form">
                    ...
                    <button class="access-button primary" type="submit">Tambah pengguna</button>
                </form>
            </section>
        @endcan

        <section class="access-card {{ auth()->user()->cannot('access.users.manage') ? 'wide-card' : '' }}">
            <div class="access-card-head">
                <div>
