        ...
        <section class="page remuneration-page" id="remunerasi">
            <div class="remuneration-toolbar">
                ...
                <div class="remuneration-actions">
                    ...
                    <button type="button" class="secondary" id="remuneration-schedule" title="Atur penanda tanggal gajian dan cutoff" aria-label="Atur penanda tanggal gajian dan cutoff"><span class="material-symbols-outlined" aria-hidden="true">settings</span></button>
                </div>
            </div>
            ...
            @can('cashier.process')
                <fieldset class="reservation-customer-type" id="reservation-deposit-choice">
                    ...
                    <div class="form-grid" id="reservation-deposit-fields" hidden>
                        ...
                        <label>Nominal DP<input name="deposit_amount" type="number" min="1" step="1" inputmode="numeric" placeholder="Otomatis 50% dari total"><small id="reservation-deposit-hint">Otomatis 50% dari total treatment dan tetap dapat diubah.</small></label>
                        <label class="full-width">Nomor referensi (opsional)<input name="deposit_reference_number" maxlength="100" placeholder="Contoh: nomor transaksi atau kode QRIS"></label>
                    </div>
                </fieldset>
            @endcan
