    ...
    <main>
        ...
        <section class="page active" id="dashboard">
            ...
            <article class="payment-revenue-card" aria-labelledby="payment-revenue-title">
                <div class="analytics-head"><div><h3 id="payment-revenue-title">Komposisi pendapatan</h3><p>Rincian pembayaran yang sudah dikonfirmasi hari ini</p></div><div class="payment-revenue-summary"><small>Total hari ini</small><strong id="payment-revenue-total">Rp0</strong><span id="payment-revenue-note">0 metode pembayaran</span></div></div>
        ...
        <section class="page" id="keuangan"><div class="metrics"><article><i class="material-symbols-outlined green">trending_up</i><div><small>Pemasukan kas</small><strong id="finance-income">Rp0</strong><span>Di luar penjualan kasir</span></div></article><article><i class="material-symbols-outlined rose">trending_down</i><div><small>Pengeluaran kas</small><strong id="finance-expense">Rp0</strong><span>Modal & biaya operasional</span></div></article><article><i class="material-symbols-outlined gold">account_balance_wallet</i><div><small>Saldo kas</small><strong id="finance-balance">Rp0</strong><span id="finance-period">Bulan berjalan</span></div></article><article><i class="material-symbols-outlined clay">receipt_long</i><div><small>Catatan kas</small><strong id="finance-cash-entry-count">0</strong><span id="finance-cash-entry-note">Bulan berjalan</span></div></article></div><div class="two-column"><div class="card"><div class="card-head"><div><h3>Ringkasan kas</h3><p>Pemasukan dan pengeluaran non-penjualan bulan berjalan</p></div></div><div class="cash-bars" id="cash-bars"></div></div><div class="card"><div class="card-head"><div><h3>Pengeluaran per kategori</h3><p>Pengeluaran kas bulan berjalan</p></div></div><div class="cash-bars finance-category-bars" id="finance-category-bars"></div></div></div><div class="card finance-history-card"><div class="card-head"><div><h3>Data kas</h3><p>Catat modal, pemasukan, pembelian, dan biaya operasional salon.</p></div><button class="primary" id="open-cash-entry"><span class="material-symbols-outlined" aria-hidden="true">add</span> Input kas</button></div><div class="finance-history-filters"><input id="cash-entry-from" type="date" aria-label="Tanggal awal"><input id="cash-entry-to" type="date" aria-label="Tanggal akhir"><select id="cash-entry-type-filter" aria-label="Filter jenis arus kas"><option value="">Semua jenis</option><option value="income">Pemasukan</option><option value="expense">Pengeluaran</option></select><input id="cash-entry-search" type="search" placeholder="Cari kategori atau deskripsi..." aria-label="Cari data kas"></div><div class="table finance-history-table" id="cash-entry-history"></div></div></section>
